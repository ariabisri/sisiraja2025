                    ...
                    <div class="card">
                        <div class="card-header mb-2">
                            ...
                            <div class="card-tools">
                                <a href="{{route("feature.create")}}" class="badge badge-success float-left mr-2">+ Tambah Feature</a>
    ...
    //     let layerId = $(this).val(); // Ambil ID layer yang dipilih
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $("#layerTitle").text("Daftar Feature pada Layer " + response.layer_name);
